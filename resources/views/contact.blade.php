                ...
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    ...
                    <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
                        ...
                        <div class="flex gap-x-4">
                            ...
                            <dd><a class="hover:text-gray-900" href="tel:+218 91 11 111 111">+218 91 111 111 1</a></dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                            ...
                            <dd><a class="hover:text-gray-900" href="mailto:info@ebidhub.ly">info@ebidhub.ly</a></dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
