<div>
    ...
    <div
        class="max-w-7xl mx-auto  pt-10 relative "
        x-data="{
        ...
        <div class="flex justify-between items-center">
            <div class="flex justify-start  flex-col ">
                ...
                <div class="flex justify-center items-center">
                    ...
                    <h6
                        class="text-base font-thin">{{$auction->about}}</h6>
                </div>
        ...
        <div class="flex justify-between  !mt-10 gap-14  ">
                ...
                <div>
                    ...
                    <div class="mt-8 w-fit">
                        ...
                        <div class="flex justify-start items-center mt-4">
                            <x-commants-section :comments="$auction->getActivitiesAttribute()"/>
                        </div>
                    </div>
                </div>
            </div>
